                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <button href='#' class="btn btn-success" data-target="#ModalAdd" data-toggle="modal">Tambah User</button>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                $no=1;   
                                  $kueri=mysqli_query($koneksi,"select * from admin");
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td> 
                                            <a href="#" class='edit' id='<?php echo $rs['username']; ?>'>Edit</a>
                                            <a href="#" onclick="confirm_modal('proses_delete_user.php?&username=<?php echo  $rs['username']; ?>');">Delete</a>
                                        </td>
                                    </tr>
                    ...
                    <div class="modal fade" id="delete">
                      <div class="modal-dialog">
                        ...
                        <div id="ModalEdit" class="modal contain" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        </div> 
...
<div class="modal-dialog">
    <div class="modal-content">
          ...
          <form action="proses_user_baru.php" name="modal_popup" enctype="multipart/form-data" method="POST">
